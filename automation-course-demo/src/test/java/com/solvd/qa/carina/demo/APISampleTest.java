...
//        api.addProperties("company_name","AAA");
...
//        api.callAPIExpectSuccess();
        ...
        String loc = response.getHeader("Location One");
        String zip = response.jsonPath().getString("0.address.zipcode");
        LOGGER.info("the zipcode: "+ zip);

        //Assert.assertEquals(zip,"1111","Zip non existent");
