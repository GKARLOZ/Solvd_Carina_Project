...
public class DesktopFireFoxWebTest implements IPick, IOpenAccount,IAbstractTest {

    @Test(dataProvider ="DP1")
    public void TestCartItems(String expandCate, String category, String item ){

        PetHomePageBase homePage = initPage(getDriver("firefox", new FirefoxCapabilities().getCapability("Firefox Test")),PetHomePageBase.class);
        homePage.open();
